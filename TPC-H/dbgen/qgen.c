...
/*
 * Definizioni mancanti per la compilazione di qgen.c
 */
#define SET_ROWCOUNT "ALTER SESSION SET ROWCOUNT=%d"
#define START_TRAN "BEGIN TRANSACTION"
#define SET_DBASE "USE %s"
#define END_TRAN "COMMIT"
#define SET_OUTPUT "SET OUTPUT TO '%s'"
#define GEN_QUERY_PLAN "EXPLAIN PLAN FOR"
