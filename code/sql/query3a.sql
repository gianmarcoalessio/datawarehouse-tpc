...
WHERE
    ...
    AND c.c_name = 'Customer#000000236' -- Sostituisci con il nome del cliente specifico
    AND EXTRACT(QUARTER FROM o.o_orderdate) = 1-- Sostituisci SpecificQuarter con il numero del trimestre
GROUP BY ROLLUP(
